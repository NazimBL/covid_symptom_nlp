...
# 3. Define original 18 symptom columns
symptom_cols = [
...
# 4. Identify gene expression columns by excluding non-gene fields
...
# 6. Plot the heatmap of symptom vs. gene pathway average expression
...
# 7. Plot Top 3 Gene Pathways per Symptom 
top_n = 3
n = len(symptom_cols)
ncols = 3
